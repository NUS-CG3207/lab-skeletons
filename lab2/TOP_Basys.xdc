...
## Clock signal
set_property PACKAGE_PIN W5 [get_ports CLK_undiv]							
...
set_property PACKAGE_PIN R2 [get_ports {DIP[15]}]					
...
set_property PACKAGE_PIN T17 [get_ports PB[0]]						
